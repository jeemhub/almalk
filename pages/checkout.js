    ...
    <div className='bg-[#EAEDED] h-[100vh]'>
        ...
        <main className='lg:flex'>
            ...
            <div className='flex flex-col p-5 space-y-5 bg-[#fff]'>
                ...
                <div className='text-end text-sm mb-0 text-[#565959] font-semibold border-b border-b-[#DDD]'>{t("Price")}</div>
        ...
        <button role={"link"} onClick={createcheckout} className='mt-5 h-10 flex mx-auto button w-full bg-[#FFD814] border-[#FCD200] hover:bg-[#FCD200] cursor-pointer'><div className='mx-auto text-lg tablet:text-base'>{t("ProceedTocheckout")}</div></button>
