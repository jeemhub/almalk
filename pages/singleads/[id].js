    ...
    return (
        <div className="bg-[#e5e7eb] tablet:bg-white">
            ...
            <div className="border-b-[2px] border-solid border-[#ffc000] w-[97%] mobile:flex justify-center  mx-auto mt-5">
                <button type="button" onClick={() => handleTabClick(0)} className={activeTab == 0 ? "bg-[#f1b51f] py-2 px-2 mobile:text-sm w-[115px] mobile:w-[40%] rounded-md shadow-md rounded-b-none h-[37px] border-[1px] border-b-0 text-[#333]  font-bold bg-gradient-to-t from-[#f1b51f] to-[#ffc000]" : "py-2 mobile:w-[30%] mobile:text-sm h-[37px] rounded-md shadow-md rounded-b-none font-bold text-[#1064bc] border-[1px] border-[#c0c0c0] bg-gradient-to-t from-[#fff] to-[#e4e2e2] px-2 "}>Ads Details</button>

                <button type="button " onClick={() => handleTabClick(1)} className={activeTab == 1 ? "bg-[#f1b51f] py-2 px-2  ml-1 mobile:w-[70%] rounded-md shadow-md rounded-b-none h-[37px] border-[1px] border-b-0 text-[#333]  font-bold bg-gradient-to-t from-[#f1b51f] to-[#ffc000] mobile:text-sm" : "py-2  h-[37px] rounded-md shadow-md rounded-b-none font-bold text-[#1064bc] ml-1 mobile:w-[60%] mobile:text-sm border-[1px] border-[#c0c0c0] bg-gradient-to-t from-[#fff] to-[#e4e2e2] px-2 "}>Location And Street View</button>
            </div>
