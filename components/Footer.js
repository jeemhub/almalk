...
<div className="max-w-[100%] mx-auto mt-5">
	...
	<footer className="p-4 bg-white sm:p-6 dark:bg-gray-800">
		<div className="md:flex md:justify-between">
			...
			<div className="grid grid-cols-2 gap-2 sm:gap-2 sm:grid-cols-6 xl:grid-cols-6 mx-auto">
				<div>
            ...
            <div>
				...
				<div>
					...
					<ul className='text-zinc-300'>
						<li className="mb-4">
							<Link href="#6" target="_blank" className="text-zinc-300 hover:underline">Privacy
								Policy</Link>
						</li>
						<li>
							<Link href="#7" target="_blank" className="text-gray-600 hover:underline dark:text-gray-400">Terms
								&amp; Conditions</Link>
						</li>
					</ul>
				</div>
		...
		<div className="sm:flex sm:items-center sm:justify-between text-sm text-gray-500 sm:text-center dark:text-gray-400">
			...
			<div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
				...
				<Link href="#9" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
					<svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
						<path fillRule="evenodd"
				...
				<Link href="#0" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
					<svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
						<path
				...
				<Link href="#00" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
					<svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
						<path fillRule="evenodd"
				...
				<Link href="#000" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
					<svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
						<path fillRule="evenodd"
