...
export default function User_drop_down({ session , children}) {
  ...
  return (
    ...
    <Menu as="div" className="ml-auto relative">
      ...
      >
        <Menu.Items className="z-40 origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-50 focus:outline-none">
          <Menu.Item>
            {({ active }) => (
